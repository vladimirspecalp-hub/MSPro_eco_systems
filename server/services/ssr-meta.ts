...
const DEFAULT_TITLE = 'Промышленный альпинизм, АКЗ по всей России — MS-PRO';
const DEFAULT_DESCRIPTION = 'АКЗ, огнезащита, высотный демонтаж — с лицензией МЧС и допуском СРО. Покрытие MSPRO Quad: гарантия 20 лет. Получить расчёт: +7 (987) 909-29-38.';
...
const STATIC_PAGES: Record<string, { title: string; description: string }> = {
    ...
    prices: {
        title: 'Прайс-лист 2026: высотные работы от 500 ₽/м² — MS-PRO',
        description: 'АКЗ от 700 ₽/м², огнезащита R60 от 900 ₽/м², демонтаж от 2 000 ₽/м². Учёт коэффициента города. Лицензия МЧС, допуск СРО. Звоните: +7 (987) 909-29-38.',
    },
    'company-team': {
...
const NAMED_SERVICES: Record<string, { title: string; description: string }> = {
    'rope-access': {
        title: 'Промышленный альпинизм — работы на высоте | MS-PRO',
        description: 'Покраска труб, АКЗ, монтаж на высоте методом пром. альпинизма. Допуск СРО, страховка. От 500 ₽/м² (покраска труб). Получить смету: +7 (987) 909-29-38.',
    },
    'fireproofing-at-height': {
        title: 'Огнезащита металлоконструкций на высоте 2026 — MS-PRO',
        description: 'Огнезащита металлоконструкций до R90 методом пром. альпинизма. Лицензия МЧС. От 900 ₽/м². MSPRO Quad — гарантия 20 лет. Расчёт: +7 (987) 909-29-38.',
    },
    'anticorrosion-at-height': {
        title: 'АКЗ металлоконструкций на высоте — MS-PRO: цены 2026',
        description: 'АКЗ металлоконструкций пром. альпинизмом. Работа от 700 ₽/м², материалы от 292 ₽/м² (ECOMAST). MSPRO Quad — гарантия 20 лет. Смета: +7 (987) 909-29-38.',
    },
    'ceiling-sanation': {
    ...
    'demolition': {
        title: 'Демонтаж металлоконструкций на высоте 2026 — MS-PRO',
        description: 'Демонтаж дымовых труб, ферм и колонн методом пром. альпинизма. Соответствие нормам промбезопасности. От 2 000 ₽/м². Вызвать инженера: +7 (987) 909-29-38.',
    },
    'hydroblast': {
        title: 'Гидроструйная очистка металла АВД без лесов | MS-PRO',
        description: 'Гидроструйная очистка металлоконструкций давлением ≥500 бар без строительных лесов. Без абразива. Металл — 175 ₽/м². Звоните: +7 (987) 909-29-38.',
    },
    'sandblasting': {
        title: 'Пескоструйная очистка металла без лесов | MS-PRO',
        description: 'Пескоструйная обработка металлоконструкций без лесов. Степени Sa 1–Sa 3 (ISO 8501). Цена от 410 ₽/м². Выезд за 1–2 дня. Звоните: +7 (987) 909-29-38.',
    },
    'facade-cleaning': {
        title: 'Очистка и мойка фасадов промышленными альпинистами | MSPRO',
        description: 'Мойка фасадов на высоте без лесов. Очистка от высолов, копоти, граффити, биопоражений. Гидроструйный и химический методы. Звоните: +7 (987) 909-29-38.',
    },
};
